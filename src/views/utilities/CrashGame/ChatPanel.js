    ...
    return (
        <>
            ...
            >
                ...
                >
                    <Typography sx={{ color: orange[500], fontWeight: 700 }}>IMPORTANT:</Typography>
                    <Typography sx={{ color: grey[200], fontWeight: 500, fontSize: 14, ml: 1 }}>
                        This game is still in Beta! If you experience problems, please contact an admin in Telegram!
                    </Typography>
                </Grid>
                ...
                <TextField
                    ...
                    InputProps={{
                        ...
                        endAdornment: (
                            <IconButton size="small" onClick={sendMessage} sx={{ bgcolor: blue[500], ':hover': { bgcolor: blue[900] } }}>
                                <TelegramIcon sx={{ fontSize: 15 }} />
                            </IconButton>
                        )
                    }}
                />
