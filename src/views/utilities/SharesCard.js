            ...
            <MainCard sx={{ width: 'full%', borderRadius: 0, backgroundColor: theme.palette.grey[900], border: 0 }} content={false}>
                <CardContent>
                    <Grid container sx={{ justifyContent: 'center', display: 'flex' }}>
                        ...
                        <Grid item lg={4.5} xs={12} md={12} sm={12} sx={{ mt: 5 }}>
                            <Card
                                sx={{
                                    borderLeft: 1,
                                    borderRight: 1,
                            ...
                            >
                                <Grid container sx={{ height: 'auto', mt: 2 }}>
                                    ...
                                    <Grid container sx={{ display: 'flex', justifyContent: 'center' }}>
                                        ...
                                        <Grid item lg={0.5} sm={0.5} sx={{ pl: 0.5, mt: 1.1, justifyContent: 'center', display: 'flex' }}>
                                            <Tooltip
                                                ...
                                                title={
                                                    ...
                                                    >
                                                        ...
                                                        moment. If user owns 1 sSTX out of 100sSTX, then that address has a share rate of 1%
                                                        and earn 1% of all BUSD rewards at that moment.`
                                                    </Typography>
                                                }
                                            >
                                                <InfoIcon />
                                ...
                                <Grid container sx={{ my: 1.5, display: 'flex', justifyContent: 'center' }}>
                                    ...
                                    <Grid item lg={12} sx={{ mt: 1, justifyContent: 'center', display: 'flex' }}>
                                        <Grid item lg={8} xs={10} md={7}>
                                            <Typography variant="h5" sx={{ mt: 2 }} color={theme.palette.grey[50]} textAlign="center">
                                                Any pending BUSD Dividends will appear here. Claim the BUSD rewards by clicking below
                                                buttons.
                                            </Typography>
                                        </Grid>
                                    </Grid>
                                    <Grid item lg={12} xs={10} sx={{ mt: 5, justifyContent: 'center', display: 'flex' }}>
                                        ...
                                        <Tooltip
                                            ...
                                            title={
                                                ...
                                                >
                                                    There is 1% fee on every STAX BUY / SELL transaction and those fees are distributed as
                                                    BUSD Dividends in a direct proportion to sSTX holders.
                                                </Typography>
                                            }
                                        >
                                            <InfoIcon />
